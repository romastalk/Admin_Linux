...
# Без пустых строк не выходит, выдает ошибку, функция принимает несколько аргументов, первый аргумент
# это собственно сам список, можно заполнить его таким образом, второй это заголовок подменю
# делаю вывод, что лучше оставить так, как есть
